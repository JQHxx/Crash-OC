...
+ (void)shield_interceptTimerAllCrash {
    ...
    dispatch_once(&onceToken, ^{
        [[NSTimer class] swizzleMethodWithOriginalSelector:@selector(timerWithTimeInterval:target:selector:userInfo:repeats:) swizzleSelector:@selector(shield_timerWithTimeInterval:target:selector:userInfo:repeats:)];

        [[NSTimer class] swizzleMethodWithOriginalSelector:@selector(scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:) swizzleSelector:@selector(shield_scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:)];
    });
}
